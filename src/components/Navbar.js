        ...
        <div className="wrapper">
            <div className="flex items-center justify-between h-18">
                ...
                <div className="ml-4 relative">
                    <div>
                        <button id="user-menu-btn" type="button" className="flex rounded-full">
                    ...
                    <div id="user-menu-dropdown" className="hidden absolute right-0 mt-2 rounded-md py-1 shadow-lg bg-white">
                        <Link to="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-neutral-200">Зарегистироваться</Link>
                        <Link to="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-neutral-200">Войти</Link>
                    </div>
